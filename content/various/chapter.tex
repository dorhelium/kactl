...
\section{Intervals}
	\kactlimport{IntervalContainer.py}
	\kactlimport{IntervalCover.py}
	\kactlimport{ConstantIntervals.py}

\section{Misc. algorithms}
	\kactlimport{TernarySearch.py}
	\kactlimport{LIS.py}
	\kactlimport{FastKnapsack.py}

\section{Dynamic programming}
	\kactlimport{KnuthDP.py}
	\kactlimport{DivideAndConquerDP.py}
...
\section{Optimization tricks}
	...
	\subsection{Pragmas}
		...
		\end{itemize}
	\kactlimport{FastMod.py}
	\kactlimport{FastInput.py}
	\kactlimport{BumpAllocator.py}
	\kactlimport{SmallPtr.py}
	\kactlimport{BumpAllocatorSTL.py}
	% \kactlimport{Unrolling.py}
	\kactlimport{SIMD.py}
